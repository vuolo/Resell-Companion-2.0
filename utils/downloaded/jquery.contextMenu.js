    ...
    var // currently active contextMenu trigger
        ...
        handle = {
            ...
            itemMouseenter: function (e) {
                ...
                for (var classItem of $this.attr("class").split(/\s+/)) {
                ...
                (opt.$menu ? opt : root).$menu
                    .children('.' + root.classNames.hover + `-${theme}`).trigger('contextmenu:blur')
            ...
            focusItem: function (e) {
                ...
                $this
                  .addClass([root.classNames.hover + `-${theme}`, root.classNames.visible].join(' '))
                  // select other items and included items
                  .parent().find('.context-menu-item').not($this)
                  .removeClass(root.classNames.visible)
                  .filter('.' + root.classNames.hover + `-${theme}`)
                ...
                if(opt && opt.$node && opt.$node.hasClass('context-menu-submenu')){
                    opt.$node.addClass(root.classNames.hover + `-${theme}`);
                }
            ...
            blurItem: function (e) {
                ...
                $this.removeClass(root.classNames.hover + `-${theme}`);
                opt.$selected = null;
            }
        },
        // operations
